import 'package:flight_app/ecran/detail_screen.dart';
import 'package:flight_app/widgets/animated_route.dart';
import 'package:flight_app/widgets/show_up_animation.dart';
import 'package:flight_app/widgets/text.dart';
      ...
      body: Column(
        children: [
          Container(
            ...
            child: TextUtil(text: "Mes vols ",color: Theme.of(context).primaryColor,weight: true,size: 28,),
          ),
